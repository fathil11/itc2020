...
<body class="grey lighten-4">
    ...
    <ul id="slide-out" class="sidenav">
        ...
        <li class="{{ (request()->is('observer')) ? 'active' : '' }}"><a class="waves-effect" href="#!"><i
        ...
        <div class="row">
            ...
            <div id="participant-menu">
                ...
                <li class="{{ (request()->is('admin/participant/table')) ? 'active' : '' }}"><a class="waves-effect"
                        href="#!"><i class="material-icons">clear_all</i>Tabel Peserta</a>
                </li>
            </div>

            <div id="correction-menu">
                <li><a class="subheader">Koreksi</a></li>
                <li class=""><a class="waves-effect" href="#!"><i class="material-icons">remove_red_eye</i>Koreksi
                        Jawaban</a></li>
            </div>
        </div>
        <div class="divider"></div>
