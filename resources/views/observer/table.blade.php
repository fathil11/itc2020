            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ url('observer/update/'.$participant->id) }}" method="post"
                                class="d-inline">
                                @csrf
                                @method('post')
                                <button class="btn waves-effect amber darken-2 waves-light tooltipped"
                                    data-position="top" data-tooltip="Update Peserta" type="submit" name="action">
